...
Feedstock license: [BSD-3-Clause](https://github.com/AnacondaRecipes/spark-nlp/blob/main/LICENSE.txt)
...
`spark-nlp` can be installed with:
...
Updating spark-nlp-feedstock
========================

If you would like to improve the spark-nlp recipe or build a new
